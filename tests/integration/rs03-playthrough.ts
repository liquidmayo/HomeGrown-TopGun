/**
 * RS3: First Strike — Full NATO playthrough.
 * WP ground attack wave vs NATO CAP and air defenses.
 */
...
function playRS3() {
  section('RS3: FIRST STRIKE — FULL PLAYTHROUGH');
  let state = loadScenario('rs03');
