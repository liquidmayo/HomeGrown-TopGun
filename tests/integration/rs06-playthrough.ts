/**
 * RS6: Sanitized Corridors — Full NATO playthrough.
 * WP SEAD corridor vs NATO HAWK belt.
 */
...
function playRS6() {
  section('RS6: SANITIZED CORRIDORS — FULL PLAYTHROUGH');
  let state = loadScenario('rs06');
