/**
 * RS5: Vertical Envelopment — Full NATO playthrough.
 * WP air assault with helicopters vs NATO interceptors.
 */
...
function playRS5() {
  section('RS5: VERTICAL ENVELOPMENT — FULL PLAYTHROUGH');
  let state = loadScenario('rs05');
